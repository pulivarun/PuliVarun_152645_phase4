...
public class WalletServiceImpl implements IWalletService {
	...
	public List<Transaction> printTransactions(Customer customer) throws ClassNotFoundException, SQLException {
		
		
	    List<Transaction> builder = iWalletDao.printTransactions(customer);
